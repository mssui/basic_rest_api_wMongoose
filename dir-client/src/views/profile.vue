...
<div class="column is-1"></div>
        <p class="subtitle">{{user}} tarafından eklenen içerikler</p>
        <div id="user-post-loop">
...
export default {
    ...
    mounted(){
      ...
      .then(response => {
        ...
        console.log("Main Data:", this.posts)
        console.log("title:", this.posts[2].title)
        console.log("read:", this.posts.text)
